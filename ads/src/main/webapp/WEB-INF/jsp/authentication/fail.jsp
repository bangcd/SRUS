		...
		<section class="container section section-first">
			<div class="row justify-content-center">
				...
				<header class="col-12 col-lg-12 col-xl-10 post-header">
					...
					<h1 class="title title--h2 js-lines">인증 활성화 실패</h1>
					<h1 class="title title--h2 js-lines">카드 갱신이 필요합니다.</h1>
				</header>
				<div class="col-12 col-lg-12 col-xl-10 post-header">
					<button type="button" class="btn btn__medium w-50"
						onclick="location.href='/rental' ">대여 정보로 이동</button>
				</div>
				<div class="col-12 col-lg-12 col-xl-10 post-header">
					<button type="button" class="btn btn__medium w-50"
						onclick="location.href='/member/certification' ">카드 갱신으로
						이동</button>
				</div>
			</div>
		</section>
